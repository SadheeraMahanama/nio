        ...
        return(
            <ScrollView style={{backgroundColor:'white'}}>
              ...
              <View style={styles.headerBlock}>
                <View style={{width:  '18%', height: 75, backgroundColor: 'white',  padding:10,}}>
                    <Icon  name="camera"                    
                        size={45} color="#6D0F49"/>
                </View>
                  <View style={{width: '82%', height: 75, backgroundColor: 'white',  padding:10,}} >
                         <TextInput
                            style={{height: 40, borderColor: 'gray', borderWidth: 1, borderRadius:20}}
              ...
              <Subtitle style={{color:"black"}}>Provide a group subject and optional group icon</Subtitle>
          </View>
          </View>
          <View>
          <SearchInput 
            ...
            <View key={email.id} style={styles.cardContainer}>
              ...
              <View style={styles.headerBlock}>
                <View style={{width:  '15%', height: 75, backgroundColor: 'white',  padding:10,}}>
                  ...
                  <View style={{ width:'85%', height: 75, backgroundColor: 'white',  padding:10,}}>
                  <CheckBox
                    // center
                    ...
                    checkedColor='red'
                    checked={() => this.setState({checked: !this.state.checked})}
